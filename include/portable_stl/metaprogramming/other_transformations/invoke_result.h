...
namespace other_transformations_helper {
  ...
  /**
   * @brief Medium class to ckeck if type is ref wrapper.
   * Given type is not a ref wrapper.
   */
  template<class> class is_reference_wrapper final {
  public:
    /**
     * @brief Result ot testing.
     */
   ...
   */
  template<class t_type> struct is_reference_wrapper<::portable_stl::reference_wrapper<t_type>> final {
  public:
    /**
     * @brief Result ot testing.
     */
  ...
  public:
    ...
    template<class T,
             ...
             class    = ::portable_stl::enable_if_bool_constant_t<::portable_stl::is_base_of<B, Td>>>
    ...
    template<class T,
             class Td = ::portable_stl::decay_t<T>,
             class    = ::portable_stl::enable_if_bool_constant_t<typename is_reference_wrapper<T>::type>>
    ...
    template<
      class T,
      class Td = ::portable_stl::decay_t<T>,
      class    = ::portable_stl::enable_if_bool_constant_t<::portable_stl::negation<::portable_stl::is_base_of<B, Td>>>,
      class    = ::portable_stl::enable_if_bool_constant_t<
        ::portable_stl::negation<typename is_reference_wrapper<T>::type>>>
    ...
    template<class T,
             class... Args,
             class MT1,
             class = ::portable_stl::enable_if_bool_constant_t<::portable_stl::is_function<MT1>>>
